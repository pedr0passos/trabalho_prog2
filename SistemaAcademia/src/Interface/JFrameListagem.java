...
public class JFrameListagem extends javax.swing.JFrame {

    public JFrameListagem() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        labelTituloListagem.setFont(new java.awt.Font("Segoe UI", 1, 22)); // NOI18N
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        listaAlunos.setModel(modelNovo);
    }//GEN-LAST:event_formWindowOpened

    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        JFramePrincipal.janelaListagem = false;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameListagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameListagem().setVisible(true);
            }
        });
    }
